const CONFIG = {
  ...
  //   "rgb(0,60,113)",
  // ]
  SPECTRUM: ["rgb(104,175,252)", "rgb(165,227,173)", "rgb(65,216,244)", "rgb(159,216,65)", "rgb(208,168,249)", "rgb(56,240,172)", "rgb(248,186,124)", "rgb(88,242,76)", "rgb(112, 149, 181)", "rgb(244,212,3)"]
}
